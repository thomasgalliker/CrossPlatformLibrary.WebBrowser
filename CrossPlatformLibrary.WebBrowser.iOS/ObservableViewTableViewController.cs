...
{
    public class CrossPlatformLibrary.WebBrowserTableViewController<T> : UITableViewController, INotifyPropertyChanged
    {
        public const string SelectedItemPropertyName = "SelectedItem";

        private CrossPlatformLibrary.WebBrowser<T> dataSource;
        ...
        /// </summary>
        public CrossPlatformLibrary.WebBrowser<T> DataSource
        {
            get
            {
        ...
        /// </summary>
        public CrossPlatformLibrary.WebBrowserTableViewController()
        ...
        public CrossPlatformLibrary.WebBrowserTableViewController(UITableViewStyle tableStyle)
            : base(tableStyle)
        {
            this.Initialize();
        }
        ...
        {
            private readonly CrossPlatformLibrary.WebBrowserTableViewController<T2> controller;
            ...
            public ObservableTableSource(CrossPlatformLibrary.WebBrowserTableViewController<T2> controller)
            {
